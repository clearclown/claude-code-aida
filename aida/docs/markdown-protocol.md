...
> **参考**: [MarkdownTaskManager](https://github.com/ioniks/MarkdownTaskManager) の AI_WORKFLOW.md パターンを採用
...
**Created**: 2025-01-20 | **Started**: 2025-01-21 | **Due**: 2025-01-22 | **Finished**: 2025-01-22
**Tags**: #feature #api

タスクの説明（自由文）。**`##` や `###` の見出しは禁止**。
...
**Notes**:
**Result**: 実装完了
**Modified files**: src/auth/login.go (lines 42-58)
**Technical decisions**: JWT認証を採用
```
...
| フィールド | 必須 | 形式 |
|-----------|------|------|
| `### TASK-XXX \|` | Yes | タスクID + タイトル |
| `**Priority**:` | Yes | Critical / High / Medium / Low |
| `**Category**:` | Yes | Backend / Frontend / DevOps 等 |
| `**Created**:` | Yes | YYYY-MM-DD |
| `**Assigned**:` | No | @worker-X |
...
```markdown
<!-- Config: Last Task ID: 042 -->
```

kanban.md の先頭にこのコメントを配置し、新規タスク作成時に自動インクリメント。
